...
const Footer = () => {
  return (
    <div className="w-4/5 flex sm:flex-row flex-col justify-between items-center my-4 mx-auto py-5">
      ...
      <p className="text-white text-base text-center cursor-pointer"><a href="/" className="mx-4 cursor-pointer">Market</a></p>
      <p className="text-white text-base text-center cursor-pointer"><a href="/collections" className="mx-4 cursor-pointer">Collection</a></p>
      <p className="text-white text-base text-center cursor-pointer"><a href="https://c4ei.net/home" target="_blank" rel="noopener noreferrer">AAH</a></p>
      <p className="text-white text-base text-center cursor-pointer"><a href="https://c4ex.net" target="_blank" rel="noopener noreferrer">AAH Buy</a></p>
      <p className="text-white text-base text-center cursor-pointer"><a href="https://docs.google.com/document/d/1S3HcMW2EmzvCEtDeF4JdSrbZOuO0JdPOHl5Stc0lhbE/edit?usp=sharing" target="_blank" rel="noopener noreferrer">사용법(DOC)</a></p>
    </div>
  )
}
